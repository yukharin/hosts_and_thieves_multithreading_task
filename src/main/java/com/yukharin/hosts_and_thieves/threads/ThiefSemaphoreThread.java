...
public final class ThiefSemaphoreThread implements Runnable {
    ...
    public ThiefSemaphoreThread(final Thief thief, final Home home, final int permits, final AtomicInteger counter, final Phaser phaser, final Semaphore semaphore) {
